...
output "dynamodb_main_table" {
  description = "Información de la tabla principal DynamoDB (Single Table Design) en producción"
  value       = module.finance_tracker.dynamodb_main_table
}

output "dynamodb_table_design" {
  description = "Información del diseño de tabla utilizado en producción"
